...
public class HealthCheckTask implements Runnable {
    ...
    /**
     * HttpHealthCheckProcessor为Nacos支持的基于HTTP的永久实例健康检查机制的处理类，TcpSuperSenseProcessor为Nacos支持的基于TCP的永久实例健康检查机制的处理类，MysqlHealthCheckProcessor为Nacos支持的基于数据库健康检查的永久实例健康检查机制的处理类。
     */
    @Override
    public void run() {
